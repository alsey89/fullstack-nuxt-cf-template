/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.staging.jsonc` (hash: 9fd4a642a5cd1234b097cdbb698b02a2)
// Runtime types generated with workerd@1.20251001.0 2025-10-01 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		DB: D1Database;
		AUTH_SIGNIN_LIMITER: RateLimit;
		AUTH_SIGNUP_LIMITER: RateLimit;
		AUTH_PASSWORD_RESET_LIMITER: RateLimit;
		OAUTH_AUTHORIZE_LIMITER: RateLimit;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "NUXT_PUBLIC_ENVIRONMENT">> {}
}
