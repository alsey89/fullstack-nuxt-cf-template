...
/**
 * Alias for base fields - keeping for backward compatibility
 * (Previously used for global entities like Company, Permission definitions)
 */
export const globalBaseFields = baseFields
